...
// Custom Picker Modal Component (same as New Session)
...
export default function EditSessionScreen() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (!session) {
        Alert.alert(t('common.error'), t('sessions.sessionNotFound'));
        router.back();
        return;
      }
      ...
      Alert.alert(t('common.error'), t('sessionComplete.failedToLoadSession'));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>{t('sessions.loadingSession')}</Text>
      </View>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t('sessions.editSession')}</Text>
...
// Styles are identical to New Session
